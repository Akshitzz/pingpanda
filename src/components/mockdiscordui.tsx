...
return (
<div className="flex min-h-[800px] w-full bg-discord-background text-white rounded-lg overflow-hidden shadow-xl ">
{/* server list */}
...
{[...Array(5).map((_,i)=>
<div key={i} className="size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-background-color cursor-not-allowed">
    <span className="text-lg font-semibold text-gray-400">
        {String.fromCharCode(65 +i)}
    </span>
</div>)]}
<div  className=" group size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed mt-auto">
 <PlusCircle className=" group-hover:text-white text-[#3ba55c]"/>
</div>
</div>
{/* dm list */}
<div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
    <div className="px-4 h-16 border-b border-[#202225] text-sm flex items-center shadow-sm">
            ...
            <h3 className="text-xs font-semibold text-[#8e9297] px-2 mb-2 uppercase">
                Direct Messages
                 ...
                 <div className="my-1 space-y-px">
                    {[...Array(4)].map((_,i)=>(
                        <div key={i} className="flex items-center px-2 py-1.5 rounded tet-gray-600 cursor-not-allowed">
...
<div className="flex items-center">
    ...
    <p className="font-semibold text-white">PingBear</p>
     </div>
    ...
    <div className="p-4">
        <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input type="text" readOnly placeholder="Messagr @PingPanda"  className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#72767d] focus-outline-none cursor-not-allowed"/>
