...
return(
    <div className="text-full flex items-center uitems-start justify-start">
...
<div className="w-full max-w-xl">
    <div className="flex items-center">
        ...
        <span className="ml-2 px-1.5 py-0.5 text-xs font-semibold bg-brand-600 text-white rounded">App
        </span>
    ...
    <div className="bg-[#2f3136] text-sm w-full rounded p-3 mb-4 mt-1.5">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2">{badgeText?<span className={cn("inline-flex order-2 items-center rounded-md px-3 py-1 text-xs font-medium ring-1 ring-inset",getBadgeStyle("#faa61a"))}>{badgeText}</span>: null}
