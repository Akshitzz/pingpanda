...
return (
    <Card contentClassName="max-w-full flex flex-col items-center p-6 "
    className="flex-1 flex items-center justify-center"
    >
        <h2 className="text-xl/8 font-medium text-center tracking-tight text-gray-950">
        Create your first {categoryName} event
        </h2>
        <p className="text-sm/6 text-gray-600 mb-8 max-w-md text-center text-pretty">Get started by sending a request to our tracking API </p>
        <div className="w-full max-w-3xl bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-gray-800 px-4 py-2 flex justify-between items-center">
                ...
                <span className="text-gray-500">your-first-event.js</span>   
            </div>
            ...
            <div className="mt-8 flex flex-col items-center space-x-2">
             ...
             <span className="text-sm text-gray-600">Listening to incoming events ...</span>
                ...
                Need help? Check out our {" "} <a href="#" className="text-blue-600 hover:underline">documentation</a>{" "} or {" "}
