"use client"
// synchronize auth status to databse
...
return <div className="flex flex-1 justify-center items-center px-4">
<BackgroundPattern className="absolute inset-0 left-1/2 z-0 -translate-x-1/2 opacity-75 "/>
<div className="relative z-10 -translate-y-1/2 flex-col items-center gap-6 text-center">
<LoadingSpinner/>
